...
exports.PlantEnergyService = void 0;
class PlantEnergyService {
    /**
     ...
     */
    static async getEnergyTotals(operationsDb, businessPlantId) {
        try {
      ...
      `, [businessPlantId]);
            const energyTotalsCalculated = {
                ...
                average_capacity_factor_calculated: parseFloat(energyResult.rows[0]?.avg_capacity_factor || 0),
                measurement_period: `${energyResult.rows[0]?.earliest_date?.toISOString().split('T')[0] ||
                    'N/A'} to ${energyResult.rows[0]?.latest_date?.toISOString().split('T')[0] ||
                    'N/A'}`,
            };
...
exports.PlantEnergyService = PlantEnergyService;
//# sourceMappingURL=plantEnergy.js.map