// services/plants/plantAllowancesService.ts
...
export class PlantAllowancesService {
  /**
  ...
  ): Promise<AllowancesCalculated | null> {
    try {
      ...
      const allowancesSurplusCalculated =
        allowanceData.total_allowances_available - allowancesNeededCalculated;

      const allowancesCalculated: AllowancesCalculated = {
