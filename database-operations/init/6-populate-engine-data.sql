...
-- Generate engine generation records with revenue (10 records per engine, 24h apart)
INSERT INTO engine_generation (engine_id, measurement_date, gross_generation, net_generation, auxiliary_power, operating_hours, capacity_factor, revenue) VALUES
-- Engine 1 (Natural Gas - 185MW) - Revenue calculated at ~$55/MWh
(1, '2024-01-01', 1620000, 1554000, 66000, 8760, 95.1, 85470.00),
(1, '2024-01-02', 1598400, 1533840, 64560, 8650, 93.8, 84361.20),
(1, '2024-01-03', 1641600, 1574640, 66960, 8870, 96.5, 86605.20),
(1, '2024-01-04', 1609200, 1543680, 65520, 8700, 94.4, 84902.40),
(1, '2024-01-05', 1652400, 1585920, 66480, 8930, 97.1, 87225.60),
(1, '2024-01-06', 1587600, 1523040, 64560, 8580, 92.5, 83767.20),
(1, '2024-01-07', 1630800, 1564560, 66240, 8810, 95.8, 86050.80),
(1, '2024-01-08', 1620000, 1554000, 66000, 8760, 95.1, 85470.00),
(1, '2024-01-09', 1641600, 1574640, 66960, 8870, 96.5, 86605.20),
(1, '2024-01-10', 1598400, 1533840, 64560, 8650, 93.8, 84361.20),

-- Engine 2 (Methane - 4.3MW) - Revenue calculated at ~$52/MWh
(2, '2024-01-01', 37668, 36120, 1548, 8760, 95.1, 1878.24),
(2, '2024-01-02', 37152, 35636, 1516, 8650, 93.8, 1853.07),
(2, '2024-01-03', 38184, 36654, 1530, 8870, 96.5, 1906.01),
(2, '2024-01-04', 37410, 35904, 1506, 8700, 94.4, 1867.01),
(2, '2024-01-05', 38442, 36900, 1542, 8930, 97.1, 1918.80),
(2, '2024-01-06', 36894, 35388, 1506, 8580, 92.5, 1840.18),
(2, '2024-01-07', 37926, 36378, 1548, 8810, 95.8, 1891.66),
(2, '2024-01-08', 37668, 36120, 1548, 8760, 95.1, 1878.24),
(2, '2024-01-09', 38184, 36654, 1530, 8870, 96.5, 1906.01),
(2, '2024-01-10', 37152, 35636, 1516, 8650, 93.8, 1853.07),

-- Engine 3 (Methane - 4.0MW) - Revenue calculated at ~$52/MWh
(3, '2024-01-01', 35040, 33600, 1440, 8760, 95.1, 1747.20),
(3, '2024-01-02', 35040, 33120, 1440, 8650, 93.8, 1722.24),
(3, '2024-01-03', 35520, 34080, 1440, 8870, 96.5, 1772.16),
(3, '2024-01-04', 34800, 33360, 1440, 8700, 94.4, 1734.72),
(3, '2024-01-05', 35760, 34320, 1440, 8930, 97.1, 1784.64),
(3, '2024-01-06', 34320, 32880, 1440, 8580, 92.5, 1709.76),
(3, '2024-01-07', 35280, 33840, 1440, 8810, 95.8, 1759.68),
(3, '2024-01-08', 35040, 33600, 1440, 8760, 95.1, 1747.20),
(3, '2024-01-09', 35520, 34080, 1440, 8870, 96.5, 1772.16),
(3, '2024-01-10', 34560, 33120, 1440, 8650, 93.8, 1722.24);
...
GROUP BY e.engine_id, e.model, e.nameplate_capacity, e.status
